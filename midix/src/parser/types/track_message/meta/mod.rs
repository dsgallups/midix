...
use crate::parser::reader::{inv_data, ReadResult, Reader};
        ...
        'slc: 'a,
    {
        ...
        Ok(match type_byte {
            ...
            0x51 => {
                ...
                Meta::Tempo(TempoRef::new(data.try_into().unwrap()))
            }
            0x54 => {
                //TODO
            ...
            0x58 if data.len() >= 4 => {
                ...
                Meta::TimeSignature(TimeSignatureRef::new(data.try_into().unwrap()))
            }
            0x59 => {
                if data.len() != 2 {
                    return Err(inv_data(
                ...
                Meta::KeySignature(KeySignatureRef::new(data.try_into().unwrap()))
            }
