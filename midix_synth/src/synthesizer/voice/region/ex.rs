...
impl RegionEx {
    ...
    pub fn start_volume_envelope(envelope: &mut VolumeEnvelope, region: &RegionPair, key: u8) {
    ...
    pub fn start_vibrato(lfo: &mut Lfo, region: &RegionPair) {
        lfo.start(
    ...
    pub fn start_modulation(lfo: &mut Lfo, region: &RegionPair) {
        lfo.start(
